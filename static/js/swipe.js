...
!function (a, b) {
    ...
    function Swipe(c, d) {
        ...
        function e() {
            u = y.children, x = u.length, u.length < 2 && (d.continuous = !1), t.transitions && d.continuous && u.length < 3 && (y.appendChild(u[0].cloneNode(!0)), y.appendChild(y.children[1].cloneNode(!0)), u = y.children), v = new Array(u.length), w = c.getBoundingClientRect().width || c.offsetWidth, y.style.width = u.length * w * 2 + "px";
            for (var a = u.length; a--;) {
                var b = u[a];
                b.style.width = w + "px", b.setAttribute("data-index", a), t.transitions && (b.style.left = a * -w +
                    "px", k(a, z > a ? -w : a > z ? w : 0, 0))
            }
            d.continuous && t.transitions && (k(h(z - 1), -w, 0), k(h(z + 1), w, 0)), t.transitions || (y.style.left = z * -w + "px"), c.style.visibility = "visible"
        }
            ...
            var e = +new Date,
                f = setInterval(function () {
                    ...
                    return g > c ? (y.style.left = b + "px", D && n(), d.transitionEnd && d.transitionEnd.call(event, i(),
                        u[z]), void clearInterval(f)) : void (y.style.left = (b - a) * (Math.floor(g / c * 100) / 100) + a + "px")
                }, 4)
        }
        ...
        if (c) {
            ...
            var z = parseInt(d.startSlide, 10) || 0,
                A = d.speed || 300;
            d.continuous = void 0 !== d.continuous ? d.continuous : !0, d.autoRestart = void 0 !== d.autoRestart ? d.autoRestart : !1;
            var B, C, D = d.auto || 0,
                E = {}, F = {}, G = {
                    ...
                    move: function (a) {
                        ...
                        F = {
                            ...
                            o(), d.continuous ? (l(h(z - 1), F.x + v[h(z - 1)], 0), l(z, F.x + v[z], 0), l(h(z + 1), F.x + v[h(z + 1)], 0)) : (F.x = F.x / (!z && F.x > 0 || z === u.length - 1 && F.x < 0 ? Math.abs(
                        ...
                        C || (c && !e ? (f ? (d.continuous ? (k(h(z - 1), -w, 0), k(h(z + 2), w, 0)) : k(z - 1, -w, 0),
                            k(z, v[z] - w, A), k(h(z + 1), v[h(z + 1)] - w, A), z = h(z + 1)) : (d.continuous ? (k(h(z + 1), w, 0), k(h(z - 2), -w, 0)) : k(z + 1, w, 0), k(z, v[z] + w, A), k(h(z - 1), v[h(z - 1)] + w, A), z = h(z - 1)), d.callback && d.callback(i(), u[z])) : d.continuous ? (k(h(z - 1), -w,
                            A), k(z, 0, A), k(h(z + 1), w, A)) : (k(z - 1, -w, A), k(z, 0, A), k(z + 1, w, A))), q(a) ? (y.removeEventListener("mousemove", G, !1), y.removeEventListener("mouseup", G, !1), y.removeEventListener(
                            "mouseleave", G, !1)) : (y.removeEventListener("touchmove", G, !1), y.removeEventListener(
                            "touchend", G, !1))
                    },
                    transitionEnd: function (a) {
                        parseInt(a.target.getAttribute("data-index"), 10) === z && ((D || d.autoRestart) && p(), d.transitionEnd && d.transitionEnd.call(a, i(), u[z]))
                    }
                };
            return e(), D && n(), t.addEventListener ? (t.touch && y.addEventListener("touchstart", G, !1), d.draggable && y.addEventListener("mousedown", G, !1), t.transitions && (y.addEventListener("webkitTransitionEnd", G, !1), y.addEventListener("msTransitionEnd", G, !1), y.addEventListener("oTransitionEnd", G, !1), y.addEventListener(
                "otransitionend", G, !1), y.addEventListener("transitionend", G, !1)), a.addEventListener("resize", G, !1)) : a.onresize = function () {
                e()
            }, {
                setup: function () {
                    e()
